...
<hr />
<h1>잔액조회</h1>
<form action="${context}/bank/remaind.do" id="frm_guest_remaind" method="post">
	<input type="button" value="잔액조회" id="btn_guest_remaind" />
	<input type="hidden" value="hong" name="userid"/> <!-- 임의의 ID : hong 을 같이 보냄 -->
</form>
<hr />
<h1>입금</h1>
<form action=""></form>
